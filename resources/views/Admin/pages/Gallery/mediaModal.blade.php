                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-4">
                            <label for="" class="form-label">Albums<span class="text-danger">*</span></label>
                            <select class="form-select" name="gallery_album_id" id="gallery_album_id">
                                <option value="">Select one</option>
                                @foreach ($albums as $index => $album)
                                    <option value="{{ $index }}">{{ $album }}</option>
                                @endforeach
                            </select>
                        </div>
